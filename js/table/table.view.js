...
function renderRequests(requests) {
    // очистили исходные шаблонные заявки
    ...
    for (let request of requests){
        const template = `<tr>
            ...
            // Добавление шаблонной строки в конец массива
...
function renderBadgeNew(number) {
    ...
    // Проверка на наличине новых задач, если их нет, то убираем со страницы индикатор колличества заявок
    if(number == 0) {
